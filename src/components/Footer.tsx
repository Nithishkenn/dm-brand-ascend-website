    ...
    <footer className="bg-black text-white pt-10 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          <div>
            <h3 className="text-2xl font-bold font-display mb-4">THE<span className="text-brand-orange">DM</span>BRAND</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#process" className="text-gray-400 hover:text-brand-orange transition-colors">How We Work</a></li>
              <li><a href="#case-studies" className="text-gray-400 hover:text-brand-orange transition-colors">Results</a></li>
        ...
        <div className="border-t border-gray-800 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} The DM Brand Company. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <a href="#" className="text-gray-500 text-sm hover:text-brand-orange transition-colors mr-4">Privacy Policy</a>
              <a href="#" className="text-gray-500 text-sm hover:text-brand-orange transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </div>
